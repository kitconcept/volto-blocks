...
const messages = defineMessages({
  ...
  AllEvents: {
    id: 'Show All Events Button',
    defaultMessage: 'Show All Events Button',
  },
  reversedOrder: {
    id: 'Reversed order',
  ...
  return (
    <>
      <Segment className="form sidebar-listing-data">
        ...
        {/* <CheckboxWidget
          id="listingblock-all-events-button"
          title={intl.formatMessage(messages.AllEvents)}
          value={data.button ? data.button : false}
          onChange={(name, value) => {
            onChangeBlock(block, {
              ...data,
              button: value,
