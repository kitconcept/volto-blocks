...
const ListingBody = ({ data, properties, intl, path, isEditMode }) => {
  ...
  // Navigating to the root has some culprits, since the component forces
  // change of path, and in consequence, a rerender of the component. We
